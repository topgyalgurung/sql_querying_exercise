...
SELECT category, AVG(rating) AS abg_rating FROM analytics GROUP BY category ORDER BY rating DESC;
...
SELECT app_name, reviews, price FROM analytics WHERE price BETWEEN 0.10 AND 1.0 ORDER BY reviews DESC LIMIT 10;
